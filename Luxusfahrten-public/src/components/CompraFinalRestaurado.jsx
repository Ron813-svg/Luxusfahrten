...
function ResumenCompraRestaurado({ datosCompra, datosVehiculo2, fechaEntrega }) {
    ...
    <div className="container mt-4 p-5 d-flex justify-content-center">
      <div className="card shadow" style={{ width: "600px" }}>
        <div className="card-header bg-primary text-white">
          <h2 className="mb-0">Resumen de Compra (Restaurado)</h2>
        </div>
...
export default ResumenCompraRestaurado;