...
const RegisterEmpleado = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const camposObligatorios = [
      'marca', 'modelo', 'anio', 'precio', 'tipo', 
      'color', 'descripcion', 'especificaciones', 'disponibilidad'
    ];
    
    const camposFaltantes = camposObligatorios.filter(campo => 
      formData[campo] === '' || formData[campo] === null
    );

    if (camposFaltantes.length > 0) {
      alert('Por favor, complete todos los campos obligatorios antes de agregar.');
      return;
    }
    ...
    // Si todo es válido, ahora podemos redirigir
    navigate('/restaurados/');
  };
        ...
        <form onSubmit={handleSubmit}>
          <div className="row g-3">
            ...
            <div className="col-md-6">
              ...
              <div className="mb-3">
                <label className="form-label text-white">Imagen</label>
                <div className="d-flex align-items-center">
                  ...
                  >
                    {imagenPreview ? (
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#888" className="bi bi-camera" viewBox="0 0 16 16">
                  ...
                  <input 
                    ...
                    accept="image/*"
                  />
                  <label htmlFor="imagen" className="btn btn-light btn-sm me-2">Añadir</label>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6">
              ...
              <div className="mb-3">
                <label htmlFor="especificacionesRestauracion" className="form-label text-white">Especificaciones restauración</label>
                <input 
                  type="text" 
                  className="form-control bg-white text-dark border-0" 
                  id="especificacionesRestauracion"
                  name="especificacionesRestauracion"
                  value={formData.especificacionesRestauracion}
                  onChange={handleChange}
                  placeholder="Especificaciones de lo restaurado"
                />
              </div>

              <div className="mb-4">
                <label htmlFor="costoRestauracion" className="form-label text-white">Costo restauración</label>
                <input 
                  type="text" 
                  className="form-control bg-white text-dark border-0" 
                  id="costoRestauracion"
                  name="costoRestauracion"
                  value={formData.costoRestauracion}
                  onChange={handleChange}
                  placeholder="Costo total de la restauración"
                />
              </div>
