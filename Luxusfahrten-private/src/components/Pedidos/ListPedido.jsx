...
const ListPedido = ({
  ...
  const filteredPedidos = pedidos?.filter(pedido =>
    ...
    pedido.idCliente?.name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    pedido.idCliente?.lastName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    pedido.idCliente?.email?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    // Buscar por datos del vehículo
    pedido.idVehiculo?.idBrand?.name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    pedido.idVehiculo?.idModel?.name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    pedido.idVehiculo?.year?.toString().includes(searchTerm) ||
    pedido.idVehiculo?.color?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    // Buscar por precio
    pedido.precioTotal?.toString().includes(searchTerm)
  ) || [];
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#2d2d2d', padding: '20px' }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className="d-flex align-items-center">
          <h2 className="text-white fw-bold mb-0 me-4">
      ...
      <div style={{
        ...
        {!loading && filteredPedidos.length === 0 && searchTerm && (
          <div className="text-center py-5">
        ...
        {!loading && (!pedidos || pedidos.length === 0) && !searchTerm && (
          <div className="text-center py-5">
            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-cart text-muted mb-3" viewBox="0 0 16 16">
          ...
          <div>
            <div className="d-flex justify-content-between align-items-center mb-3">
              <span className="text-muted">
                Mostrando {filteredPedidos.length} de {pedidos?.length || 0} pedidos
              </span>
            </div>
