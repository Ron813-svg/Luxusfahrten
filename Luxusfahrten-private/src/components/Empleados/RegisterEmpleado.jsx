        ...
        <form onSubmit={handleSubmit}>
          <div className="row">
            <div className="col-md-6">
              <div className="mb-3">
                <label htmlFor="nombre" className="form-label text-white">Ingrese su nombre completo</label>
                <input 
                  type="text" 
            ...
            <div className="col-md-6">
              <div className="mb-3">
                <label htmlFor="fechaActual" className="form-label text-white">Fecha actual</label>
                <div className="input-group">
                  <input 
                    type="date" 
                    className="form-control bg-dark text-white border-0" 
              ...
              <div className="mb-3">
                <label htmlFor="tipoEmpleado" className="form-label text-white">Tipo de empleado</label>
                <select 
